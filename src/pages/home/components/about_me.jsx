...
const AboutMe = () => {
    return (
        <div className="flex flex-col justify-start items-start bg-[rgb(15,15,15)] rounded-[30px] text-white shadow-lg w-full sm:w-[800px] h-auto sm:h-[236.4px] max-w-full opacity-100 p-4">
            ...
            <a href="./about" className="flex items-center justify-center bg-[rgb(26,26,26)] text-[rgb(172,153,255)] rounded-lg shadow-lg w-full py-2 group">
                <p className="mr-2 hover:text-opacity-50 transition duration-300">More about Me</p>
                <div className="group-hover:animate-slide-right">
